...
// --- Redirect connected users to their dashboard ---
if (isLoggedIn()) {
    if (isAdmin() || isHR()) {
        header("Location:". APP_LINK ."/admin/index.php?route=dashboard");
    } else {
        header("Location:". APP_LINK ."/employee/");
    }
    exit();
}
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <div class="d-flex gap-3 mt-4">
                    <a href="<?= Proute('login') ?>" class="btn btn-primary btn-lg px-4">Connexion</a>
                    <?php if (isAdmin()): ?>
                        <a href="<?= Proute('login') ?>" class="btn btn-outline-secondary btn-lg px-4">Créer un compte</a>
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-md-6">
