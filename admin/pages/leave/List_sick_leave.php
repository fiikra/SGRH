...
$pageTitle = "Arrêts Maladie (Sick Leave)";
include __DIR__ . '../../../../includes/header.php';
?>

<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Arrêts Maladie</h1>
        <a href="<?= route('leaves_add_sick') ?>" class="btn btn-success">
            <i class="bi bi-plus-circle"></i> Ajouter un arrêt maladie
        </a>
    </div>
                ...
                <table class="table table-striped table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        <?php if (empty($sick_leaves)): ?>
                            <tr>
                                <td colspan="8" class="text-center text-muted">Aucun arrêt maladie trouvé.</td>
                            </tr>
                        <?php else: foreach ($sick_leaves as $leave): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($leave['justification_path']) && file_exists(PROJECT_ROOT . '/' . $leave['justification_path'])): ?>
                                        <a href="/<?= htmlspecialchars($leave['justification_path']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                ...
                                <td>
                                    <span class="badge bg-success">Maladie</span>
                                </td>
